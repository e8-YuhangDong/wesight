...
export const obsidianPluginUrl = 'https://github.com/freestylefly/wesight-obsidian';
...
export const copy: Record<Language, Copy> = {
  en: {
    ...
    obsidian: {
      ...
      title: 'Bring agents into your notes',
      body: 'The WeSight Obsidian plugin connects your vault to desktop agent sessions, so you can chat, run skills, and manage tasks without leaving your notes.',
      cta: 'View on GitHub',
      features: [
        {
          title: 'Chat in notes',
          body: 'Start a cowork session from the sidebar and stream replies next to your writing.',
        },
        {
          title: 'Use skills',
          body: 'Invoke web-search, docx, xlsx, and other skills directly from Obsidian.',
        },
        {
          title: 'Stay in sync',
          body: 'Memory and scheduled tasks connect the desktop app and your vault.',
        },
      ],
    },
    engines: {
    ...
    final: {
      ...
      footerBody:
        'Open-source desktop AI Agent workspace for CLI agents, local runtimes, skills, scheduled tasks, memory, and an Obsidian plugin.',
      footerNav: {
        product: 'Product',
        workflows: 'Workflows',
        obsidian: 'Obsidian Plugin',
  ...
  zh: {
    ...
    metaDescription:
      'WeSight 是开源桌面 AI Agent 工作区，把 CLI agents、本地 runtimes、模型供应商、权限事件、Skills、定时任务、记忆和 Obsidian 插件放进同一个桌面产品表面。',
    languageToggle: 'EN',
    ...
    obsidian: {
      eyebrow: 'Obsidian 插件',
      title: '把 Agent 带进笔记',
      body: 'WeSight Obsidian 插件将仓库接入桌面 Agent 会话，让你在笔记里聊天、调用 Skills、管理任务，无需离开 Obsidian。',
      cta: '在 GitHub 查看',
      features: [
        {
          title: '在笔记中对话',
          body: '从侧边栏发起会话，流式回复与写作并排显示。',
        },
        {
          title: '调用 Skills',
          body: '在 Obsidian 内直接使用 web-search、docx、xlsx 等 Skills。',
        },
        {
          title: '数据同步',
          body: '记忆与定时任务连接桌面应用和 Obsidian 仓库。',
        },
      ],
    },
    engines: {
