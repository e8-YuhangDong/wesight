...
export function Header({ t, onToggleLanguage }: { t: Copy; onToggleLanguage: () => void }) {
  return (
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation">
        ...
        <a href="/#obsidian">{t.header.nav.obsidian}</a>
...
export function ObsidianSection({ t }: { t: Copy }) {
  return (
    <section className="obsidian-section" id="obsidian">
      <SectionIntro eyebrow={t.obsidian.eyebrow} title={t.obsidian.title} body={t.obsidian.body} />
      ...
      <div className="obsidian-actions">
        <a className="secondary-button" href={obsidianPluginUrl}>
          <Github size={18} />
          {t.obsidian.cta}
        </a>
      </div>
  ...
  return (
    <footer className="site-footer">
      ...
      <nav aria-label="Footer navigation">
        ...
        <a href="/#obsidian">{t.final.footerNav.obsidian}</a>
